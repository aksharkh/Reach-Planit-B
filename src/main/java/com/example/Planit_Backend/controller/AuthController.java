...
import com.example.Planit_Backend.dto.auth.AppleLoginDto;
...
public class AuthController {
    ...
    @PostMapping("/apple")
    public ResponseEntity<?> appleLogin(@RequestBody AppleLoginDto request) {

       String jwt = authService.loginWithApple(request.getIdentityToken());
       return ResponseEntity.ok(jwt);
    }
}
